...
const sizeStyles: Record<ButtonSize, string> = {
  sm: 'px-3 py-1.5 text-sm gap-1.5 min-h-[40px] md:min-h-0',
  md: 'px-4 py-2 text-base gap-2 min-h-[44px] md:min-h-0',
  lg: 'px-6 py-3 text-lg gap-2.5 min-h-[48px] md:min-h-0',
};
