...
import type { SwagSpec, BrandProfile, BenefitType } from '@/lib/swag/swag-types'
import { BENEFIT_TYPE_META } from '@/lib/swag/swag-types'
import type { SwagResults } from '@/lib/swag/swag-types'
import { fmtMoney, fmtMoneyCompact, fmtMultiple } from '@/lib/swag/format'
import { buildTemplateVars, resolveNarrative } from '@/lib/swag/swag-engine'
