  ...
  return (
    <div>
        ...
        {stats.map((stat) => {
          ...
          return (
            <Link key={stat.label} href={stat.href}>
              <Card className="hover:border-[var(--border-hover)] transition-colors cursor-pointer p-4 md:p-6">
                <div className="flex items-center gap-3 md:gap-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs md:text-sm text-[var(--text-secondary)] truncate">{stat.label}</p>
                  </div>
                </div>
              </Card>
            </Link>
      ...
      <Card className="overflow-hidden">
        <div className="flex items-center justify-between px-4 md:px-6 py-3 md:py-4 border-b border-[var(--border-default)]">
