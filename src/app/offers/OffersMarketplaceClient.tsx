...
interface OffersMarketplaceClientProps {
  offers: Offer[];
  partners: Partner[];
  categories: Category[];
  tags: Tag[];
...
export default function OffersMarketplaceClient({ offers, partners, categories, tags }: OffersMarketplaceClientProps) {
  // Local helpers that used to live in @/data
  ...
  // Seed the recommendation engine with real offers on mount
  useEffect(() => {
    setAvailableOffers(offers);
  }, [offers, setAvailableOffers]);
